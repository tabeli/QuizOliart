...
export class SecondQuizz_Innovador extends Component {
    state = {
        currentQuestion: 0,
        myAnswer: null,
        options: [],
    ...
    //updates the component Innovador
    ...
    render() {
        ...
        return (
            ...
            <h2>{questions}</h2>
            <span> {`Questions ${currentQuestion} out of ${Innovador.length - 1} `} </span>
            {options.map((option, optionIdx) => (
                ...
                <br/><br/><br/>
                {currentQuestion < Innovador.length - 1 &&
                    <RaisedButton
                    label="Siguiente"            
                    variant="contained"   
                    primary={false}             
